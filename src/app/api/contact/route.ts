...
export async function POST(req: Request) {
  try {
    ...
    const { name, company, email, phone, countryCode, projectType, budget, message } = body;
      ...
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        ...
        ${
          ...
          <div style="margin-top: 24px;">
            <p style="color: #888; font-size: 13px; margin-bottom: 8px;">Project Details</p>
    ...
    await transporter.sendMail({
      ...
      replyTo: email,
      subject: `New Inquiry: ${projectType} — ${company}`,
      html: htmlContent,
    });
